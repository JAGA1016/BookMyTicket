...
CREATE TABLE IF NOT EXISTS updated_stations_schedule (
    sch_id bigint NOT NULL,
    old_data jsonb,
    new_data jsonb,
    modified_type dml_type NOT NULL,
    modified_timestamp timestamp NOT NULL,
    created_by varchar(255) NOT NULL,
    PRIMARY KEY (sch_id, modified_type, modified_timestamp)
);

INSERT INTO  railway_manager(manager_username,password) VALUES('railway_master','rail'); 
